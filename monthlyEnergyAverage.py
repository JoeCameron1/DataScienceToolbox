...
if args.boxplot:
    ...
    if args.default:
        ...
        ideal_data = ideal_data.groupby([ideal_data["Time"].dt.month, ideal_data["Time"].dt.hour]).mean()
        # Save new CSV of energy data
        ideal_data.to_csv('MonthlyAveEnergyCSV/' + sys.argv[3][-14:] + 'MonthlyAverage.csv')
    # MINUTE
    elif args.minute:
